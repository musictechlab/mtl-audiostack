# Contributing to mtl-audiostack
...
1. Check existing [issues](https://github.com/musictechlab/mtl-audiostack/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-audiostack/discussions)
